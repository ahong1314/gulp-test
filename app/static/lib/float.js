 ...
 *  浮動 (預設右上 top:150)
 *  @example   $("#id").Float();
 *  @param {topSide:150,floatRight:1|1,side:5,close:ID}
 */
$.fn.Float = function(obj, param) {
    var that = this;

    var lock = {
        topSide: param && param.topSide || 150,
        floatRight: param && param.floatRight || 1,
        side: param && param.side || 5, //margin
        close: param && param.close,
        init: function() {
            var el = that,
